...
public class CreateController extends HttpServlet {
     ...
     * @throws dao.ConexaoException
     * @throws dao.BancoDaoException
     */
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int inserir = contaDaoRelacional.inserir(novaConta);
            request.setAttribute("situacao", inserir);
            
            RequestDispatcher requestDispatcher
                    = getServletContext().getRequestDispatcher("confirmaNovaConta.jsp");
